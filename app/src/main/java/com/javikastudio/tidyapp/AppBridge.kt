...
class AppBridge(private val context: Context, private val webView: WebView) {
    ...
    @JavascriptInterface fun isBedtimeSkippedTonight()         = bedtime.isBedtimeSkippedTonight()
    @JavascriptInterface fun skipBedtimeTonight()              = bedtime.skipBedtimeTonight()
    @JavascriptInterface fun isBedtimeFilterManaged()          = bedtime.isBedtimeFilterManaged()
    @JavascriptInterface fun removeScreenFilterForced()        = bedtime.removeScreenFilterForced()
